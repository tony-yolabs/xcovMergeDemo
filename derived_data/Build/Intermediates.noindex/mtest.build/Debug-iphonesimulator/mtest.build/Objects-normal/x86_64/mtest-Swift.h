...
#ifndef MTEST_SWIFT_H
#define MTEST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="mtest",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5mtest11AppDelegate")
...
SWIFT_CLASS("_TtC5mtest13SceneDelegate")
...
SWIFT_CLASS("_TtC5mtest14ViewController")
@interface ViewController : UIViewController
- (IBAction)btnFizz:(UIButton * _Nonnull)sender;
- (IBAction)btnEven:(UIButton * _Nonnull)sender;
- (IBAction)btnPrime:(UIButton * _Nonnull)sender;
- (void)viewDidLoad;
